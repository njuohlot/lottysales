  ...
  <footer>
    ...
    <div class="footer-links">
        <div class="footer-link">
            <img src="../assets/images/vans.jpg" alt="" width="100px">
            <h3>STEP 2023 EDITION</h3>
            <p>Step into the forefront of fashion with our latest collection<br> of shoes. From sleek heels to trendy sneakers.</p>
        </div>
        <div  class="footer-link">
            <h2>NAVIGATION</h2>
             <ul>
                ...
                <li>  
             <router-link to="#">All collections</router-link></li>
        ...
        <div  class="footer-link">
            ...
            <ul>
                ...
                <li> <router-link to="#">Shipping & Delivery</router-link></li>
        ...
        <div  class="footer-link">
            ...
            <ul>
                ...
                <li> <router-link to="#">Bestseller</router-link></li>
                <li> <router-link to="#">Latest</router-link></li>
            </ul>     
        </div>
        <div  class="footer-link">
            <h2>CATEGORIES</h2>
            <ul>
                <li><router-link to="#">Sneakers</router-link></li>
                <li> <router-link to="#">Brogue boots</router-link></li>
                <li><router-link to="#">Leather Shoes</router-link></li>
                <li><router-link to="#">Running Shoes</router-link></li>
                <li><router-link to="#">Sports Shoes</router-link></li>
            </ul>      
        </div>
    </div>

    <div class="bottom">© 2023 Copyright: <router-link to="#">All VanS</router-link>
    </div>
  </footer>
</template>

<script>
import OfferDeals from './OfferDeals.vue';
export default {
  name: "FooterTemplate",
  components:{
    OfferDeals,
